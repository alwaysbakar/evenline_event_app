...
class EventDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BlocProvider(
    ...
    child: BlocBuilder<TicketSelectionCubit, TicketSelectionState>(
      builder: (context, state) => _EventDetailContent(
        event: event,
        store: store,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          FavoriteButton(event: event, store: store),
        ],
      ),
      body: ListView(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              IconButton(
                onPressed: context.read<TicketSelectionCubit>().increment,
...
class FavoriteButton extends StatefulWidget {
  const FavoriteButton({required this.event, required this.store, super.key});
  final Event event;
  final AppStore store;
  @override
...
class _FavoriteButtonState extends State<FavoriteButton> {
  ...
  void initState() {
    super.initState();
    widget.store.isFavorite(widget.event.id).then((value) {
  ...
  Widget build(BuildContext context) => IconButton(
    onPressed: () async {
      final next = !saved;
      await widget.store.setFavorite(widget.event.id, next);
